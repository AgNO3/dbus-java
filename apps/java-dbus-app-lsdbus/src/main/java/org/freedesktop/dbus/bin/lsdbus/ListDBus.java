 ...
 */
package org.freedesktop.dbus.bin.lsdbus;
...
public class ListDBus {
    ...
    private static final Logger log = Logger.getLogger(ListDBus.class);
    ...
    public static void main ( String args[] ) throws Exception {
        ...
        try ( DBusConnection conn = DBusConnection.getConnection(connection) ) {
            ...
            log.error("Failed to enumerate bus ", e);
        }
    }
}
