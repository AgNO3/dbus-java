...
public class DirectConnection extends AbstractConnection {
    ...
    private static final Logger log = Logger.getLogger(DBusConnection.class);
     ...
     * 
     * @param address
     *            The address to connect to. This is a standard D-Bus address, except that the additional parameter
     *            'listen=true' should be added in the application which is creating the socket.
     */
    ...
    public DirectConnection ( String address, ClassLoader cl ) throws DBusException {
        super(address, cl);
    ...
    public static String createDynamicTCPSession () {
        ...
        log.info("Created Session address: " + address);
